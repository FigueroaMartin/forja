...
body{background:var(--bg);color:var(--txt);font-family:var(--mono);-webkit-font-smoothing:antialiased;overflow-x:hidden;}
...
.nav-wa{display:inline-flex;align-items:center;gap:.45rem;padding:.42rem 1rem;background:transparent;border:.5px solid var(--gold);color:var(--gold);font-family:var(--mono);font-size:.58rem;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;transition:all .22s;}
.nav-wa:hover{background:var(--gold);color:#000;}
.nav-wa:hover svg path{fill:#000;}
.nav-wa svg{flex-shrink:0;}
.nav-wa svg path{transition:fill .22s;fill:var(--gold);}
...
@media(max-width:600px){
  .nav-top{padding:.75rem 1.25rem;}
  .nav-right{gap:.75rem;}
  .nav-wm{font-size:1.05rem;letter-spacing:.14em;}
  .nav-wa{padding:.38rem .6rem;}
...
.pc-iw{position:relative;overflow:hidden;aspect-ratio:4/3;background:var(--surf2);}
...
.pc-b{padding:.9rem 1.2rem 1.25rem;display:flex;flex-direction:column;gap:.4rem;flex:1;}
