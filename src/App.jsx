...
.nav-wa{display:inline-flex;align-items:center;gap:.45rem;padding:.42rem 1rem;background:#000;border:.5px solid var(--brd2);color:var(--white);font-family:var(--mono);font-size:.58rem;letter-spacing:.12em;text-transform:uppercase;text-decoration:none;transition:border-color .22s,color .22s;}
.nav-wa:hover{border-color:var(--gold);color:var(--gold);}
.nav-wa:hover svg path{fill:var(--gold);}
.nav-wa svg{flex-shrink:0;transition:fill .22s;}
